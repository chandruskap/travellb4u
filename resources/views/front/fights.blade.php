    ...
    <section id="content" style="margin-top: 70px;">
        <div class="search-box-wrapper" style="background-color: #ccc;">
            <div class="search-box container" style="padding-top: 15px;">
                <ul class="search-tabs clearfix">
                    <li><a href="#hotels-tab" data-toggle="tab"><i class="fa fa-tick"></i>HOTELS</a></li>
        ...
        <div class="section">
            <div class="container">
                        ...
                        <div class="col-sm-4">
                            <article class="box">
                                <figure class="animated" data-animation-type="fadeInDown">
                                    <a title="" href="flight-detailed.html"><img alt="" src="images/1.png"></a>
                                    <figcaption>
                        ...
                        <div class="col-sm-4">
                            <article class="box">
                                <figure class="animated" data-animation-type="fadeInDown" data-animation-delay="0.6">
                                    <a title="" href="flight-detailed.html"><img alt="" src="images/2.png"></a>
                                    <figcaption>
                        ...
                        <div class="col-sm-4">
                            <article class="box">
                                <figure class="animated" data-animation-type="fadeInDown" data-animation-delay="0.9">
                                    <a title="" href="flight-detailed.html"><img alt="" src="images/3.png"></a>
                                    <figcaption>
                ...
                <div class="image-carousel style2 block" data-animation="slide" data-item-width="270"
                    data-item-margin="30">
                    <ul class="slides image-box listing-style2 flight">
                        <li>
                            <article class="box">
                                <figure>
                                    <span><img src="images/1.png" alt="" width="270" height="160" /></span>
                                </figure>
                                <div class="details">
                                    <a title="View all" href="flight-detailed.html"
                                        class="pull-right button btn-mini uppercase">select</a>
                        ...
                        <li>
                            <article class="box">
                                <figure>
                                    <span><img src="images/2.png" alt="" width="270" height="160" /></span>
                                </figure>
                                <div class="details">
                                    <a title="View all" href="flight-detailed.html"
                                        class="pull-right button btn-mini uppercase">select</a>
                        ...
                        <li>
                            <article class="box">
                                <figure>
                                    <span><img src="images/3.png" alt="" width="270" height="160" /></span>
                                </figure>
                                <div class="details">
                                    <a title="View all" href="flight-detailed.html"
                                        class="pull-right button btn-mini uppercase">select</a>
                        ...
                        <li>
                            <article class="box">
                                <figure>
                                    <span><img src="images/4.png" alt="" width="270" height="160" /></span>
                                </figure>
                                <div class="details">
                                    <a title="View all" href="flight-detailed.html"
                                        class="pull-right button btn-mini uppercase">select</a>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="toggle-container with-image block" id="accordion3" data-image-animation-type="fadeIn"
                            data-image-animation-duration="2">
                            <div class="panel style1">
                                <img src="images/before-you-fly.png" alt="" />
                                <h4 class="panel-title">
                                    <a href="#acc7" data-toggle="collapse" data-parent="#accordion3">Book your Bags in
                                        Advance</a>
                                </h4>
                                <div class="panel-collapse collapse in" id="acc7">
                                    <div class="panel-content">
                                        <p>Nunc cursus libero purus ac congue ar lorem cursus ut sed pulvinar massa iden
                                            porta nequetiam elerisque mi id habitant morbi tristique senectus.</p>
                                    </div>
                                    <!-- end content -->
                                </div>
                            </div>
                            ...
                            <div class="panel style1">
                                <img src="images/before-you-fly.png" alt="" />
                                <h4 class="panel-title">
                                    <a class="collapsed" href="#acc8" data-toggle="collapse"
                                        data-parent="#accordion3">Special Meal Requests</a>
                                </h4>
                            ...
                            <div class="panel style1">
                                <img src="images/before-you-fly.png" alt="" />
                                <h4 class="panel-title">
                                    <a class="collapsed" href="#acc9" data-toggle="collapse"
                                        data-parent="#accordion3">Check your Flight Status</a>
                                </h4>
