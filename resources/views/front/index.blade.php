...
@section('contents')
    <section id="content" style="margin-top: 70px;">
        <div class="search-box-wrapper" style="background-color: #ccc;">
            <div class="search-box container" style="padding-top: 15px;">
                <ul class="search-tabs clearfix">
                    <li class="active"><a href="#hotels-tab" data-toggle="tab"><i
                                class="fa fa-tick"></i>HOTELS</a></li>
                    <li><a href="#flights-tab" data-toggle="tab">FLIGHTS</a></li>
                    <li><a href="#flight-and-hotel-tab" data-toggle="tab">FLIGHTS &amp; HOTELS</a></li>
                        ...
                        <form action="flight-list-view.html" method="post">
                            <div class="row">
                                <div class="form-group col-sm-12 col-md-12">
                                    <ul class="flight-ul">
                                        <li><label class="form-check-label" for="round-trip">
                                                <input class="form-check-input" type="radio" name="trip" id="round-trip">
                                                Round Trip
                                            </label></li>
                                        <li><label class="form-check-label" for="one-way">
                                                <input class="form-check-input" type="radio" name="trip" id="one-way">
                                                One-Way
                                            </label></li>
                                        <li><label class="form-check-label" for="multi-city">
                                                <input class="form-check-input" type="radio" name="trip" id="multi-city">
                                                Multi-city
                                            </label></li>
                    ...
                    <div class="tab-pane fade" id="flight-and-hotel-tab">
                        <form action="flight-list-view.html" method="post">
                            <div class="row">
                                <ul class="flight-ul">
                                    <li><label class="form-check-label" for="round-trip">
                                            <input class="form-check-input" type="radio" name="trip" id="round-trip"> Round
                                            Trip
                                        </label></li>
                                    <li><label class="form-check-label" for="one-way">
                                            <input class="form-check-input" type="radio" name="trip" id="one-way"> One-Way
                                        </label></li>
                                    <li><label class="form-check-label" for="multi-city">
                                            <input class="form-check-input" type="radio" name="trip" id="multi-city">
                                            Multi-city
                        ...
                        <article class="box">
                            <figure class="animated" data-animation-type="fadeInDown" data-animation-duration="1">
                                <a href="ajax/slideshow-popup.html" title="" class="hover-effect popup-gallery"><img
                                        src="images/d_h.png" alt="" width="270" height="160" /></a>
                            </figure>
                            <div class="details">
                                <span class="price"><small>FROM</small>$490</span>
                                <h4 class="box-title"><a href="hotel-detailed.html">Atlantis - The
                                        Palm<small>Paris</small></a></h4>
                            </div>
                        </article>
                    </div>
                    <div class="col-sms-6 col-sm-6 col-md-3">
                        <article class="box">
                            ...
                            <div class="details">
                                ...
                                <h4 class="box-title"><a href="hotel-detailed.html">Hilton
                                        Hotel<small>LONDON</small></a></h4>
                            </div>
                        </article>
                    </div>
                    <div class="col-sms-6 col-sm-6 col-md-3">
                        <article class="box">
                            ...
                            <div class="details">
                                ...
                                <h4 class="box-title"><a href="hotel-detailed.html">MGM Grand<small>LAS
                                            VEGAS</small></a></h4>
                            </div>
                        </article>
                    </div>
                    <div class="col-sms-6 col-sm-6 col-md-3">
                        <article class="box">
                            ...
                            <div class="details">
                                ...
                                <h4 class="box-title"><a href="hotel-detailed.html">Crown
                                        Casino<small>ASUTRALIA</small></a></h4>
                            </div>
                        </article>
                    </div>
                </div>
        ...
        <div class="honeymoon section global-map-area promo-box parallax" data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="col-sm-6 content-section description pull-right">
                    ...
                    <p>Nunc cursus libero purusac congue arcu cursus utsed vitae pulvinar massa idporta neque purusac Etiam
                        elerisque mi id faucibus iaculis vitae pulvinar.</p>
                    <div class="row places image-box style9">
                        <div class="col-sms-4 col-sm-4">
                            <article class="box">
                                <figure>
                                    <a href="hotel-list-view.html" title=""
                                        class="hover-effect yellow middle-block animated" data-animation-type="fadeInUp"
                                        data-animation-duration="1">
                                        <img src="images/hot-hotel1.png" alt="" /></a>
                                </figure>
                                <div class="details">
                        ...
                        <div class="col-sms-4 col-sm-4">
                            <article class="box">
                                <figure>
                                    <a href="hotel-list-view.html" title=""
                                        class="hover-effect yellow middle-block animated" data-animation-type="fadeInUp"
                                        data-animation-duration="1" data-animation-delay="0.4"><img
                                            src="images/hot-hotel1.png" alt="" /></a>
                                </figure>
                                <div class="details">
                        ...
                        <div class="col-sms-4 col-sm-4">
                            <article class="box">
                                <figure>
                                    <a href="hotel-list-view.html" title=""
                                        class="hover-effect yellow middle-block animated" data-animation-type="fadeInUp"
                                        data-animation-duration="1" data-animation-delay="0.8"><img
                                            src="images/hot-hotel1.png" alt="" /></a>
                                </figure>
                                <div class="details">
                ...
                <div class="col-sm-6 image-container no-margin">
                    <img src="images/global-map.jpg" alt="" class="animated" data-animation-type="fadeInUp"
        ...
        <div class="offers section">
            <div class="container">
                ...
                <p class="col-xs-9 center-block no-float text-center">Mauris ullamcorper nibh quis leo ultrices in
                    hendrerit velit tristiqueut augue in nulla lacinia bibendum liberoras rutrum ac purus ut tristique.
                    Nullam placerat lacinia dolor quis pretium. Phasellus vitae lacinia quam, at pellentesque
                    lorem. Sed euismod turpis quis mattis fringilla.</p>
                <div class="row image-box style2">
                    <div class="col-md-6">
                        <article class="box">
                            <figure class="animated" data-animation-type="fadeInLeft" data-animation-duration="1">
                                <a href="#" title=""><img src="images/image-1.jpeg" alt="" width="270" height="192" /></a>
                            </figure>
                            <div class="details">
                                <h4>Hire Cars</h4>
                    ...
                    <div class="col-md-6">
                        <article class="box">
                            <figure class="animated" data-animation-type="fadeInLeft" data-animation-duration="1"
                                ...
                                <a href="#" title=""><img src="images/image-2.jpeg" alt="" width="270" height="192" /></a>
                            </figure>
                            <div class="details">
                                <h4>Cruise Deals</h4>
                                <p>Nunc cursus libero purus ac congue ar lorem cursus ut sed vitae pulvinar massa idend
                    ...
                    <div class="col-md-6">
                        <article class="box">
                            <figure class="animated" data-animation-type="fadeInLeft" data-animation-duration="1">
                                <a href="#" title=""><img src="images/image-4.jpeg" alt="" width="270" height="192" /></a>
                            </figure>
                            <div class="details">
                                <h4>Things To Do</h4>
                                <p>Nunc cursus libero purus ac congue ar lorem cursus ut sed vitae pulvinar massa idend
            ...
            <div class="container">
                <div class="row image-box style7">
                    <div class="col-sms-6 col-sm-6 col-md-3">
                        <article class="box">
                            <figure class="middle-block">
                                <img src="images/image-5.jpeg" alt="" class="middle-item" />
                                <span class="opacity-wrapper"></span>
                            </figure>
                            <div class="details">
                                <h4><a href="#">Best Price Guarantee</a></h4>
                                <p>
                                    Nunc cursus libero purus ac congue arcu cursus ut sed vitae pulvinar massa idporta
                    ...
                    <div class="col-sms-6 col-sm-6 col-md-3">
                        <article class="box">
                            <figure class="middle-block">
                                <img src="images/image-6.jpeg" alt="" class="middle-item" />
                                <span class="opacity-wrapper"></span>
                            </figure>
                            <div class="details">
                    ...
                    <div class="col-sms-6 col-sm-6 col-md-3">
                        <article class="box">
                            <figure class="middle-block">
                                <img src="images/image-7.jpeg" alt="" class="middle-item" />
                                <span class="opacity-wrapper"></span>
                            </figure>
                            <div class="details">
                    ...
                    <div class="col-sms-6 col-sm-6 col-md-3">
                        <article class="box">
                            <figure class="middle-block">
                                <img src="images/image-4.jpeg" alt="" class="middle-item" />
                                <span class="opacity-wrapper"></span>
                            </figure>
                            <div class="details">
